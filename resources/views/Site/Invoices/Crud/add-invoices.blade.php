...
<div class="breadcrumb-header justify-content-between">
    <div class="my-auto">
        <div class="d-flex">
            <h4 class="content-title mb-0 my-auto">{{ __('Invoices') }}</h4><span
                ...
                <form action="{{ route('invoice.store') }}" method="post" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-4">
                            ...
                            <input class="form-control fc-datepicker" name="due_date_invoice" placeholder="YYYY-MM-DD"
                                type="date">
                            <div>
                    ...
                    <div class="row">
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control" id="inputName" name="collection">
                            <div>
                                @error('collection')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                    ...
                    <div class="row">
                        <div class="col">
                            ...
                            <input type="text" name="commission" class="form-control form-control-lg" id="Commission">
                            <div>
                                @error('commission')
                                <p style="color: red">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="col">
                            ...
                            <input type="text" class="form-control form-control-lg" id="Discount" value="0"
                                name="discount">
                            <div>
                                @error('discount')
                                <p style="color: red">{{ $message }}</p>
                        ...
                        <div class="col">
                            ...
                            <select name="vat" id="Rate_VAT" class="form-control">
                                <!--placeholder-->
                                <option value="" selected disabled>Select Precent</option>
