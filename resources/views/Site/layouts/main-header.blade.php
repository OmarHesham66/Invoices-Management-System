		...
		<div class="main-header-right">
				...
				<li class="">
					<div class="dropdown  nav-itemd-none d-md-flex">
						...
						<div class="dropdown-menu dropdown-menu-left dropdown-menu-arrow" x-placement="bottom-end">
							...
							<a href="{{ URL::current() . '/?lang=ar' }}" class="dropdown-item d-flex">
								<span class="avatar  ml-3 align-self-center bg-transparent"><img
			...
			<div class="nav nav-item  navbar-nav-right ml-auto">
					...
					<div class="dropdown-menu">
						...
						<div class="main-notification-list Notification-scroll">
							<a class="d-flex p-3 border-bottom">
								...
								<div class="mr-3">
									<h5 class="notification-label mb-1">No Notifications</h5>
									<div class="notification-subtext">no notifications rececived yet</div>
								</div>
								{{-- <div class="mr-auto">
									<i class="las la-angle-left text-left text-muted"></i>
								</div> --}}
				...
				<div class="dropdown main-profile-menu nav nav-item nav-link">
					<a class="profile-user d-flex" href=""><img alt="" src="{{URL::asset(Auth::user()->photo)}}"></a>
					<div class="dropdown-menu">
						<div class="main-header-profile bg-primary p-3">
							<div class="d-flex wd-100p">
								<div class="main-img-user"><img alt="" src="{{URL::asset(Auth::user()->photo)}}"
										class=""></div>
						...
						<a class="dropdown-item" href="{{ url('/profile/edit/') }}"><i class="bx bx-cog"></i> Edit
							Profile</a>
						{{-- <a class="dropdown-item" href=""><i class="bx bxs-inbox"></i>Inbox</a> --}}
						{{-- <a class="dropdown-item" href=""><i class="bx bx-envelope"></i>Messages</a> --}}
						{{-- <a class="dropdown-item" href=""><i class="bx bx-slider-alt"></i> Account Settings</a> --}}
						<a class="dropdown-item" href="{{ url('/logout' . $page='page-signin') }}"><i
